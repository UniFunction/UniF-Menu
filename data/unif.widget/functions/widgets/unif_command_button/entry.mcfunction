...
execute unless data storage unif.menu:cache Cache.Print.Widget.value.command run data modify storage unif.menu:cache Cache.Print.Widget.value.click_value set value ""


function unif.widget:widgets/unif_command_button/output with storage unif.menu:cache Cache.Print.Widget.value
